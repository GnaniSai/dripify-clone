...
function ABTest() {
  return (
    <div className="flex gap-6 justify-center items-center mt-30 mb-30">
      <div className="w-[80%] flex justify-between gap-15">
        <div className="w-full">
          <img src={abtest} alt="abtest" className="w-[85%]" />
        </div>
        ...
        <div className="flex flex-col gap-5 w-[90%] mt-4">
          ...
          <h2 className="text-5xl">A/B test your message</h2>
          ...
          <div className="w-full flex justify-around mt-10 flex-wrap">
            <div className="flex items-start  gap-4 w-[50%] mb-10">
              <div>
            ...
            <div className="flex items-start gap-4 w-[50%]">
              <div>
