  ...
  return (
    <div className="w-[85%] flex justify-center items-center p-4 max-sm:w-full text-white">
      <div className="w-full flex justify-between items-center">
        ...
        <ul className="flex gap-7 items-center">
          <li className="max-xl:hidden">Book Demo</li>
          <li className="max-xl:hidden">Login</li>
          <li className="bg-white text-black pt-3 pb-3 pl-7 pr-7 font-bold rounded-lg max-xl:hidden">
            Start for free
          </li>
          <li>
            <img src={menu} alt="menu" className="hidden max-xl:flex" />
          </li>
        </ul>
      </div>
    </div>
